    ...
    <div className="flex h-full overflow-hidden">
      ...
      <aside className="w-80 flex-shrink-0 flex flex-col bg-white border-r border-gray-200 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 flex-shrink-0">
          <div>
            <h1 className="text-base font-bold text-gray-900">WhatsApp Inbox</h1>
        ...
        <div className="px-5 py-2.5 border-b border-gray-100 flex-shrink-0">
          <div className="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-700 bg-gray-50 px-2.5 py-1 rounded-full">
        ...
        <div className="flex-1 overflow-y-auto">
          {error ? (
            <div className="p-5 text-sm text-gray-500">{error}</div>
      ...
      <main className="flex-1 flex items-center justify-center bg-gray-50 overflow-hidden">
        <div className="text-center text-gray-400">
          <div className="w-20 h-20 rounded-3xl bg-white border border-gray-200 shadow-sm flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-xs text-gray-400 mt-1">Choose a chat from the list to view messages</p>
        </div>
      </main>
    </div>
  );
